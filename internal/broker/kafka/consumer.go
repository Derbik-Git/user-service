...
func NewConsumer(brokers []string, topic string, groupID string, log *slog.Logger, handler HendlerEventForTest) *Consumer {
	return &Consumer{
		log:     log,
		handler: handler,
