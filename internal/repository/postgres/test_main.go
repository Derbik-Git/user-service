...
.. 
// !!! оставил точки что бы к эому вернуться, проверить целесообразно ли не обрабатывать ошибку при закрытии бд, может быть стоит её обработать и залогировать, а не игнорировать, так же стоит ли вообще закрывать бд, может быть она сама закроется при завершении тестов, нужно проверить
